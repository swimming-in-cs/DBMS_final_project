...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt->execute()) {
            $message = "Player info deleted successfully";
        } else {
...
<head>
        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.php">Delete Player</a>
    ...
    <body>
        ...
        <h3>Please Enter the ID of the player you want to delete below</h3>
        <form class="player-info-form" action="" method="post">
            <div class="form-row">
                ...
                <div class="col">
                    <input class="btn btn-primary" type="submit" value="Delete Player">
                </div>
            </div>
        </form>
