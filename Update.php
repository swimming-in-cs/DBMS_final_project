...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Bind the parameters (the order of parameters should match the order in the SET clause of the UPDATE statement)
        $stmt->bind_param("ssisii", $name, $handPreference, $height, $country, $age, $id);
...
<head>
        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.php">Update Player Info</a>
    ...
    <body>
        ...
        <h3>Please Enter the updated info of the player below</h3>
